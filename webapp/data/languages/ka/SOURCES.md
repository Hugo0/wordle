# Georgian Language Data - Sources
...
- `ka_daily_words.txt`: Top 2000 most common words from existing word list, ranked by OpenSubtitles frequency
- `ka_5words_supplement.txt`: 3424 additional valid 5-letter words from FrequencyWords corpus
