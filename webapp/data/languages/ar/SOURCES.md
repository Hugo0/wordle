...
- `ar_daily_words.txt`: Top 2000 most common words from existing word list, ranked by OpenSubtitles frequency
- `ar_5words_supplement.txt`: 9950 additional valid 5-letter words from FrequencyWords corpus
