# Lithuanian Language Data - Sources
...
- `lt_daily_words.txt`: Top 2000 most common words from existing word list, ranked by OpenSubtitles frequency
- `lt_5words_supplement.txt`: 4338 additional valid 5-letter words from FrequencyWords corpus
