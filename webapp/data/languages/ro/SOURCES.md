# Romanian Language Data - Sources
...
- `ro_daily_words.txt`: Top 2000 most common words from existing word list, ranked by OpenSubtitles frequency
- `ro_5words_supplement.txt`: 2959 additional valid 5-letter words from FrequencyWords corpus
