# Galician Language Data - Sources
...
- `gl_daily_words.txt`: Top 2000 most common words from existing word list, ranked by OpenSubtitles frequency
- `gl_5words_supplement.txt`: 3374 additional valid 5-letter words from FrequencyWords corpus
