...
- `eu_daily_words.txt`: Top 2000 most common words from existing word list, ranked by OpenSubtitles frequency
- `eu_5words_supplement.txt`: 2396 additional valid 5-letter words from FrequencyWords corpus
