...
- `fa_daily_words.txt`: Top 2000 most common words from existing word list, ranked by OpenSubtitles frequency
- `fa_5words_supplement.txt`: 4423 additional valid 5-letter words from FrequencyWords corpus
