# Norwegian Nynorsk Language Data - Sources
...
- `nn_daily_words.txt`: Top 2000 most common words from existing word list, ranked by OpenSubtitles frequency
- `nn_5words_supplement.txt`: 3817 additional valid 5-letter words from FrequencyWords corpus
