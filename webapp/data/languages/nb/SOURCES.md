# Norwegian Bokmål Language Data - Sources
...
- `nb_daily_words.txt`: Top 2000 most common words from existing word list, ranked by OpenSubtitles frequency
- `nb_5words_supplement.txt`: 3491 additional valid 5-letter words from FrequencyWords corpus
