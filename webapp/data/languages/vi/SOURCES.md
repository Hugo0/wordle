# Vietnamese Language Data - Sources
...
- `vi_daily_words.txt`: Top 738 most common words from existing word list, ranked by OpenSubtitles frequency
- `vi_5words_supplement.txt`: 5246 additional valid 5-letter words from FrequencyWords corpus
