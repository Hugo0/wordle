# Estonian Language Data - Sources
...
- `et_daily_words.txt`: Top 2000 most common words from existing word list, ranked by OpenSubtitles frequency
- `et_5words_supplement.txt`: 2952 additional valid 5-letter words from FrequencyWords corpus
