# Western Armenian Language Data - Sources
...
- `hyw_daily_words.txt`: Top 2000 most common words from existing word list, ranked by OpenSubtitles frequency
- `hyw_5words_supplement.txt`: 787 additional valid 5-letter words from FrequencyWords corpus
