import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, defineComponent, shallowRef, h, resolveComponent, getCurrentInstance, computed, unref, createElementBlock, provide, cloneVNode, defineAsyncComponent, shallowReactive, ref, Suspense, Fragment, useSSRContext, createApp, watch, withCtx, createVNode, mergeProps, createTextVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, nextTick, getCurrentScope, toRef, isReadonly, toRaw, isRef, isShallow, isReactive } from 'vue';
import { c as createError$1, p as parseQuery$1, n as hasProtocol, l as joinURL, o as parseURL$1, q as encodePath$1, t as decodePath, v as getContext, w as withQuery, x as isScriptProtocol, y as withTrailingSlash, z as withoutTrailingSlash, A as sanitizeStatusCode, $ as $fetch, B as defu, C as createHooks, D as executeAsync } from '../nitro/nitro.mjs';
...
const unhead_Fi2XwT7_g5KxLZBd9yvmI8Xlxo8LwdDsdELQKpJwzyo = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const __nuxt_page_meta = { layout: "game" };
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DFL9FbB_.mjs')
  },
  {
    name: "stats",
    path: "/stats",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./stats-D6_tk5sb.mjs')
  },
  {
    name: "lang",
    path: "/:lang()",
    meta: __nuxt_page_meta || {},
    component: () => import('./index-BH-xFwCE.mjs')
  },
  {
    name: "lang-words",
    path: "/:lang()/words",
    component: () => import('./words-D0LJzL4J.mjs')
  },
  {
    name: "lang-word-id",
    path: "/:lang()/word/:id()",
    component: () => import('./_id_-CsWIunpy.mjs')
  }
];
...
const revive_payload_server_2nK_Pct_5CaEIizxb1dlEKns9xdi5elJZb14pCm9iJE = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  payloadPlugin,
  unhead_Fi2XwT7_g5KxLZBd9yvmI8Xlxo8LwdDsdELQKpJwzyo,
  plugin$1,
  revive_payload_server_2nK_Pct_5CaEIizxb1dlEKns9xdi5elJZb14pCm9iJE,
  plugin,
  components_plugin_z4hgvsiddfKkfXTP6M8M4zG5Cb7sGnDhcryKVM45Di4,
  pwa_icons_plugin_C24GcIKjcI2zsa8A86om0L2LZjx1chWtzYxD11T7Txg
];
const layouts = {
  default: defineAsyncComponent(() => import('./default-dO52FRkW.mjs').then((m) => m.default || m)),
  game: defineAsyncComponent(() => import('./game-DlPmCQCH.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen flex items-center justify-center bg-white dark:bg-neutral-900" }, _attrs))}><div class="text-center"><h1 class="text-6xl font-bold text-neutral-300 dark:text-neutral-600 mb-4">${ssrInterpolate(__props.error.statusCode)}</h1><p class="text-xl text-neutral-600 dark:text-neutral-400 mb-8">${ssrInterpolate(__props.error.message || "Page not found")}</p>`);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.21.2_@parcel+watcher@2.5.6_@types+node@25.5.0_@vue+compiler-sfc@3.5.30_cac@6.7.1_6d7d18c5e2216e9bd85e418e561ff949/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { __nuxt_component_0$1 as _, useHead as a, useRoute$1 as b, createError as c, useNuxtApp as d, entry_default as default, asyncDataDefaults as e, fetchDefaults as f, useSeoMeta as u };
