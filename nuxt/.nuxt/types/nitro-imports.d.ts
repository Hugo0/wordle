declare global {
  ...
  const MIGRATION_DAY_IDX: typeof import('../../server/utils/data-loader').MIGRATION_DAY_IDX
  const WORD_DEFS_DIR: typeof import('../../server/utils/data-loader').WORD_DEFS_DIR
  const WORD_HISTORY_DIR: typeof import('../../server/utils/data-loader').WORD_HISTORY_DIR
  const WORD_IMAGES_DIR: typeof import('../../server/utils/data-loader').WORD_IMAGES_DIR
  const WORD_STATS_DIR: typeof import('../../server/utils/data-loader').WORD_STATS_DIR
  const __buildAssetsURL: typeof import('../../node_modules/.pnpm/@nuxt+nitro-server@3.21.2_db0@0.3.4_ioredis@5.10.0_magicast@0.5.2_nuxt@3.21.2_@parcel+w_5f6482d5f82f46663f3fe203fa79cafa/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths').buildAssetsURL
  const __publicAssetsURL: typeof import('../../node_modules/.pnpm/@nuxt+nitro-server@3.21.2_db0@0.3.4_ioredis@5.10.0_magicast@0.5.2_nuxt@3.21.2_@parcel+w_5f6482d5f82f46663f3fe203fa79cafa/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths').publicAssetsURL
  ...
  const buildLanguageSession: typeof import('../../server/utils/language-builder').buildLanguageSession
  ...
  const defineAppConfig: typeof import('../../node_modules/.pnpm/@nuxt+nitro-server@3.21.2_db0@0.3.4_ioredis@5.10.0_magicast@0.5.2_nuxt@3.21.2_@parcel+w_5f6482d5f82f46663f3fe203fa79cafa/node_modules/@nuxt/nitro-server/dist/runtime/utils/config').defineAppConfig
  ...
  const fetchDefinition: typeof import('../../server/utils/definitions').fetchDefinition
  ...
  const getDailyWordConsistentHash: typeof import('../../server/utils/word-selection').getDailyWordConsistentHash
  const getDailyWordLegacy: typeof import('../../server/utils/word-selection').getDailyWordLegacy
  ...
  const getTodaysIdx: typeof import('../../server/utils/word-selection').getTodaysIdx
  ...
  const getWordForDay: typeof import('../../server/utils/word-selection').getWordForDay
  ...
  const idxToDate: typeof import('../../server/utils/word-selection').idxToDate
  const isCorsOriginAllowed: typeof import('../../node_modules/.pnpm/h3@1.15.6/node_modules/h3').isCorsOriginAllowed
  const isDuplicateSubmission: typeof import('../../server/utils/word-stats').isDuplicateSubmission
  ...
  const loadAllData: typeof import('../../server/utils/data-loader').loadAllData
  const loadBlocklist: typeof import('../../server/utils/data-loader').loadBlocklist
  const loadCharacters: typeof import('../../server/utils/data-loader').loadCharacters
  const loadCuratedSchedule: typeof import('../../server/utils/data-loader').loadCuratedSchedule
  const loadDailyWords: typeof import('../../server/utils/data-loader').loadDailyWords
  const loadKeyboard: typeof import('../../server/utils/data-loader').loadKeyboard
  const loadLanguageConfig: typeof import('../../server/utils/data-loader').loadLanguageConfig
  const loadSupplementalWords: typeof import('../../server/utils/data-loader').loadSupplementalWords
  const loadWordStats: typeof import('../../server/utils/word-stats').loadWordStats
  const loadWords: typeof import('../../server/utils/data-loader').loadWords
  ...
  const updateWordStats: typeof import('../../server/utils/word-stats').updateWordStats
...
declare global {
  ...
  // @ts-ignore
  export type { LanguageData } from '../../server/utils/data-loader'
  import('../../server/utils/data-loader')
  // @ts-ignore
  export type { LanguageSession } from '../../server/utils/language-builder'
  import('../../server/utils/language-builder')
}
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/home/hugo/Projects/wordle/.claude/worktrees/nuxt-migration/nuxt/node_modules/.pnpm/@nuxt+nitro-server@3.21.2_db0@0.3.4_ioredis@5.10.0_magicast@0.5.2_nuxt@3.21.2_@parcel+w_5f6482d5f82f46663f3fe203fa79cafa/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/home/hugo/Projects/wordle/.claude/worktrees/nuxt-migration/nuxt/node_modules/.pnpm/@nuxt+nitro-server@3.21.2_db0@0.3.4_ioredis@5.10.0_magicast@0.5.2_nuxt@3.21.2_@parcel+w_5f6482d5f82f46663f3fe203fa79cafa/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { WORD_IMAGES_DIR, WORD_DEFS_DIR, WORD_STATS_DIR, WORD_HISTORY_DIR, MIGRATION_DAY_IDX, loadCharacters, loadWords, loadSupplementalWords, loadBlocklist, loadDailyWords, loadCuratedSchedule, loadLanguageConfig, loadKeyboard, loadAllData } from '/home/hugo/Projects/wordle/.claude/worktrees/nuxt-migration/nuxt/server/utils/data-loader';
export { fetchDefinition } from '/home/hugo/Projects/wordle/.claude/worktrees/nuxt-migration/nuxt/server/utils/definitions';
export { buildLanguageSession } from '/home/hugo/Projects/wordle/.claude/worktrees/nuxt-migration/nuxt/server/utils/language-builder';
export { getTodaysIdx, idxToDate, getDailyWordConsistentHash, getDailyWordLegacy, getWordForDay } from '/home/hugo/Projects/wordle/.claude/worktrees/nuxt-migration/nuxt/server/utils/word-selection';
export { loadWordStats, updateWordStats, isDuplicateSubmission } from '/home/hugo/Projects/wordle/.claude/worktrees/nuxt-migration/nuxt/server/utils/word-stats';