...
describe('getHreflangLanguages', () => {
    const allCodes = [
        'ar', 'az', 'bg', 'bn', 'br', 'ca', 'ckb', 'cs', 'da', 'de',
        'el', 'en', 'eo', 'es', 'et', 'eu', 'fa', 'fi', 'fo', 'fr',
        'fur', 'fy', 'ga', 'gd', 'gl', 'ha', 'he', 'hi', 'hr', 'hu',
        'hy', 'hyw', 'ia', 'id', 'ie', 'is', 'it', 'ja', 'ka', 'ko',
        'la', 'lb', 'lt', 'ltg', 'lv', 'mi', 'mk', 'mn', 'mr', 'ms',
        'nb', 'nds', 'ne', 'nl', 'nn', 'oc', 'pa', 'pau', 'pl', 'pt',
        'qya', 'ro', 'ru', 'rw', 'sk', 'sl', 'sq', 'sr', 'sv', 'sw',
        'tk', 'tl', 'tlh', 'tr', 'uk', 'ur', 'uz', 'vi', 'yo',
    ];
