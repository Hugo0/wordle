...
const ADJECTIVES = [
    'Misty', 'Sunny', 'Snowy', 'Frosty', 'Stormy', 'Breezy', 'Dusty', 'Dewy',
    'Foggy', 'Rainy', 'Windy', 'Cloudy', 'Starry', 'Lunar', 'Solar', 'Arctic',
    'Golden', 'Silver', 'Amber', 'Coral', 'Jade', 'Ruby', 'Azure', 'Ivory',
    'Copper', 'Onyx', 'Scarlet', 'Indigo', 'Crimson', 'Emerald', 'Cobalt',
    'Swift', 'Brave', 'Clever', 'Bold', 'Keen', 'Noble', 'Wise', 'Witty',
    'Calm', 'Gentle', 'Mighty', 'Silent', 'Wild', 'Fierce', 'Proud', 'Sly',
    'Nimble', 'Plucky', 'Dapper', 'Merry', 'Peppy', 'Lively', 'Serene',
    'Velvet', 'Crystal', 'Marble', 'Rustic', 'Cosmic', 'Stellar', 'Radiant',
    'Vivid', 'Bright', 'Warm', 'Cool', 'Cozy', 'Sleek', 'Crisp', 'Polished',
    'Lucky', 'Happy', 'Quirky', 'Zesty', 'Spicy', 'Fizzy', 'Jolly', 'Perky',
    'Snappy', 'Zippy', 'Bouncy', 'Wily', 'Rosy', 'Hazy', 'Rapid', 'Steady',
];

const NOUNS = [
    'Fox', 'Owl', 'Panda', 'Wolf', 'Hawk', 'Lynx', 'Otter', 'Raven',
    'Heron', 'Finch', 'Crane', 'Wren', 'Lark', 'Robin', 'Dove', 'Falcon',
    'Badger', 'Penguin', 'Jaguar', 'Parrot', 'Salmon', 'Viper', 'Gecko',
    'Bison', 'Koala', 'Tiger', 'Eagle', 'Whale', 'Seal', 'Stork',
    'Maple', 'Cedar', 'Birch', 'Sage', 'Fern', 'Iris', 'Lotus', 'Willow',
    'Thistle', 'Clover', 'Moss', 'Bloom', 'Orchid', 'Ivy', 'Holly', 'Olive',
    'Aspen', 'Hazel', 'Poppy', 'Violet',
    'Ember', 'Spark', 'Pearl', 'Flint', 'Storm', 'Breeze', 'River', 'Brook',
    'Cliff', 'Ridge', 'Stone', 'Frost', 'Dune', 'Wave', 'Tide', 'Reef',
    'Canyon', 'Glacier', 'Summit', 'Meadow',
    'Star', 'Moon', 'Cloud', 'Comet', 'Nebula', 'Aurora', 'Eclipse', 'Nova',
    'Quill', 'Arrow', 'Anchor', 'Compass', 'Lantern', 'Prism', 'Pixel',
    'Rune', 'Token', 'Shard',
];
 ...
 */
export async function generatePasskeyIdentity(): Promise<{ displayName: string; username: string }> {
