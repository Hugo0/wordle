...
# Remove broken Armenian entries
del PHRASE_SETS["hy"]

# For the remaining languages, I'll skip ones where I can't produce quality
# translations in this session and focus on the ones I can do well.
